...
no_buf_m <- raster("./buftest1/Abarema_langsdorffii/present/partitions/maxent_cont_Abarema_langsdorffii_1_1.tif")
# plotting the model
plot(no_buf_m)
...
mn_mod <- do_any(species_name = especies[1],
                 ...
                 algo = "maxent")
# creating a raster object with the output of the model
mn_buf_m <- raster("./buftest2/Abarema_langsdorffii/present/partitions/maxent_cont_Abarema_langsdorffii_1_1.tif")
# plotting the model
plot(mn_buf_m)
...
knitr::include_graphics("./buftest1/Abarema_langsdorffii/present/data_setup/sdmdata_Abarema_langsdorffii.png") ;
knitr::include_graphics("./buftest2/Abarema_langsdorffii/present/data_setup/sdmdata_Abarema_langsdorffii.png")
```
...
dbuf_mx <- raster("./maxentdist/Abarema_langsdorffii/present/partitions/maxent_cont_Abarema_langsdorffii_1_1.tif")
plot(dbuf_mx)
maps::map(,,add = T)
knitr::include_graphics("./maxentdist/Abarema_langsdorffii/present/data_setup/sdmdata_Abarema_langsdorffii.png")
mx_dmod$TSS
```
