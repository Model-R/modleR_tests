...
We select only one species from the example data in the package. 
...
Plotting records of `r especies[1]`
...
### user defined buffer: the user provide a shapefile. Maptools package to read the ".shp" file
...
```{r remedyzzz}
knitr::include_graphics("./setupsdmdata/setupsdmdataub/Eugenia florida DC./present/partitions/sdmdata_Eugenia florida DC..png")
```
